...
IPV6_MANGLE_02_COUNT=$(sudo ip6tables --table mangle --list-rules | grep --count "IPV6_MANGLE_02")
if [ "$IPV6_MANGLE_02_COUNT" -eq "0" ]; then
...
IPV6_NAT_03_COUNT=$(sudo ip6tables --table nat --list-rules | grep --count "IPV6_NAT_03")
if [ "$IPV6_NAT_03_COUNT" -eq "0" ]; then
...
IPV4_MANGLE_02_COUNT=$(sudo iptables --table mangle --list-rules | grep --count "IPV4_MANGLE_02")
if [ "$IPV4_MANGLE_02_COUNT" -eq "0" ]; then
...
IPV4_NAT_03_COUNT=$(sudo iptables --table nat --list-rules | grep --count "IPV4_NAT_03")
if [ "$IPV4_NAT_03_COUNT" -eq "0" ]; then
  ...
  logger "IPV4_NAT_03 created"
fi

IPV4_NAT_04_COUNT=$(sudo iptables --table nat --list-rules | grep --count "IPV4_NAT_04")
if [ "$IPV4_NAT_04_COUNT" -eq "0" ]; then
  ...
  logger "IPV4_NAT_04 created"
fi

IPV4_NAT_05_COUNT=$(sudo iptables --table nat --list-rules | grep --count "IPV4_NAT_05")
if [ "$IPV4_NAT_05_COUNT" -eq "0" ]; then
  ...
  logger "IPV4_NAT_05 created"
fi

IPV4_NAT_06_COUNT=$(sudo iptables --table nat --list-rules | grep --count "IPV4_NAT_06")
if [ "$IPV4_NAT_06_COUNT" -eq "0" ]; then
